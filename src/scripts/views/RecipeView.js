...
function createIngredient(ingredient) {
    return `
        <li class="recipe__item">
            ...
            <div class="recipe__count">${Math.round(ingredient.count * 10) / 10}</div>
...
export function updateServing(recipe) {
    ...
    document.querySelectorAll(`.recipe__count`).forEach((count, i) => {
        count.textContent = Math.round(recipe.ingredients[i].count * 10) / 10;
    })
}